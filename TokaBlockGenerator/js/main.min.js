...
$(function(){function d(){switch(C){case 1:$("#help-content-1").fadeOut("fast");$("#help-content-2").slideToggle("fast");C++;break;case 2:$("#help-content-2").slideToggle("fast");$("#help-content-3").fadeIn("fast");C++;break;case 3:$("#help-content-3").fadeOut("fast");$("#page-help").hide();C=0;break;case 5:$("#help-content-1").hide();$("#help-content-2").hide();$("#help-content-3").hide();$("#page-help").hide();C=0;break;default:$("#help-content-1").fadeIn("fast"),C++}}function a(){var b=$("#input-file").prop("files")[0],
